  ...
  return (
    <footer className="bg-ink-950 pt-16 text-sand-100/80">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-5 pb-12 sm:grid-cols-2 md:grid-cols-4 md:px-8">
        <div>
          <h3 className="font-display text-xl font-semibold text-white">{site.name}</h3>
        ...
        <div>
          ...
          <ul className="mt-4 flex flex-col gap-2 text-sm">
            <li>
              <a href={`tel:${site.contact.phoneE164}`} className="transition-colors hover:text-gold-400">
                {site.contact.phone}
              </a>
            </li>
            <li>
              <a href={`mailto:${site.contact.email}`} className="transition-colors hover:text-gold-400">
                {site.contact.email}
              </a>
            </li>
